...
<head>
    ...
    <title>Fintech</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/src/main/webapp/resources/styleFintech.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/src/main/webapp/resources/bootstrap.min.css">
...
<body>
    ...
    <div class="container text-center bv">
        ...
        <img class="logofin img-fluid" src="${pageContext.request.contextPath}/src/main/webapp/resources/images/Logo.png" alt="Logo Fintech">
            ...
            <div class="col-md-6">
                <div class="card login">
                    <div class="card-body">
                        ...
                        <form action="login.jsp" method="post"> <!-- Alterar para o URL correto do processamento -->
                            ...
                            <div class="link esquecer">
                                <a href="esqueciSenha.jsp" class="esqueci">Esqueceu a senha?</a> <!-- Alterar para a página correta -->
                            </div>
                            ...
                            <div class="text-center divbotao">
                                ...
                                <button type="button" class="btn btn-block botao" onclick="location.href='criarConta.jsp';"> <i class="fa-solid fa-clipboard"></i> Criar Conta</button>
                            </div>
                        </form>
                    </div>
                </div>
